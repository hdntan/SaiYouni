...
public class PlayerCtrl : MainSingleton<PlayerCtrl>
{
   ...
   [SerializeField] protected WeaponManager weapons;
    ...
    protected virtual void LoadWeapons()
    {
        ...
        this.weapons = GetComponentInChildren<WeaponManager>();
    ...
    protected virtual void LoadThirdPersonCamera()
    {
        ...
        this.thirdPersonCamera.height = 1.7f;
